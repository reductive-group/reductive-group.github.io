...
<span class="footnote">\*The letter o is not used officially in rook script, as /ɔ/ is not phonemic in my dialect. However, for personal use, users are encouraged to spell words as they would pronounce them. For people who pronounce “cot” and “caught” distinctly, having a letter o might be useful for the “caught” vowel.</span>
...
The five long vowels of rook script are *unchecked*, meaning they do not need codas. Three of them (ii, aa, uu) are romanized as doubled short vowels, and they are monophthongs. The other two (ei, ou) are usually pronounced as diphthongs; they are not considered diphthongs by rook script since they *can* realized as monophthongs, and since they do not move far in the vowel space. The long vowels are:
...
{% include image.html src="https://i.postimg.cc/gkhtF36R/2026-04-29-vowel-space-long-vowels.jpg" alt="Long vowels chart" caption="Positions of long vowels in vowel space. Diphthongs are shown with direction of movement" %}
...
In the standard rook vowel table, note that the left and right are reversed from the traditional depiction of the vowel space. This is intended to highlight the similarity in form between the consonants /w/ and /j/ and the vowels /ʊ/ and /ɪ/, respectively.
